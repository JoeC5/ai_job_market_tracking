...
| `11_americas_map.png` | Americas regional choropleth map |
| `12_europe_map.png` | Europe regional choropleth map |
| `13_apac_map.png` | APAC and Middle East regional choropleth map |
