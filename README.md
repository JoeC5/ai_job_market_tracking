...
| `11_americas_map.png` | Americas regional choropleth map | currently not included in PowerPoint deck
| `12_europe_map.png` | Europe regional choropleth map | currently not included in PowerPoint deck
| `13_apac_map.png` | APAC and Middle East regional choropleth map | currently not included in PowerPoint deck
